        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="anggota/nskp.php">NSKP</a>
                        <a class="collapse-item" href="anggota/nkp_at.php">NKP</a>
                        <a class="collapse-item" href="anggota/nkt_at.php">NKT</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="anggota/tanggapanbimbingan.php">
                    <i class="fas fa-fw fa-chart-area"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="card-body">
                            <a href="create_sasaran.php" class="btn btn-primary mb-3">Tambah Sasaran Kinerja</a>
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <a href="detail_sasaran.php" class="btn btn-primary mb-3">Detail</a>
