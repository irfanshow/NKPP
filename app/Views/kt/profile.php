                ...
                <div class="container-fluid">
                    ...
                    <h3 class="px-2 mb-0 text-gray-800">Mengubah Profile</h3>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <form action="/kt/saveFotoProfile/<?php echo $_SESSION['id']?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4-px-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src='<?php echo base_url() ?>/assets/img/<?php echo $kt['foto_kt']?>' alt="Tidak ditermukan foto" height="200" width="250">
