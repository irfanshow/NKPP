        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="pengendali/nskp.php">NSKP</a>
                        <a class="collapse-item" href="pengendali/nkp.php">NKP</a>
                        <a class="collapse-item" href="pengendali/nkt.php">NKT</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="pengendali/tanggapanbimbingan.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="ketua/review_sasaran.php">Sasaran Kinerja</a>
                        <a class="collapse-item" href="ketua/review_nkp.php">NKP</a>
                        <a class="collapse-item" href="ketua/review_nkt.php">NKT</a>
                    </div>
                </div>
            </li>
